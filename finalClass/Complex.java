...
// неизменямый класс с статическими методами генерации
...
public final class Complex {
	...
	//методы доступа без соответствующего мутатора
	...
	// переопределение метода equals() с соблюдением общих соглашений
	public boolean equals(Object o) {
		...
		Complex c = (Complex)o;
		return (Float.floatToIntBits(realPart) ==
				Float.floatToIntBits(c.realPart)) &&
			   (Float.floatToIntBits(imaginaryPart) ==
			    Float.floatToIntBits(c.imaginaryPart));
	}
